...
<font class="text-muted">Listado completo de </font><font class="text-primary"><strong>Historial de emails </font><font class="text-danger
">Desbloqueados</strong></font><br>    
    ...
    <?php
        ...
        $consulta = mysqli_query($datos_conexion, "SELECT * FROM `historial` INNER JOIN `emailsBloqueados` ON emailsBloqueados.idEmailsBloqueados = historial.idEmailsBloqueados INNER JOIN usuarios ON historial.idUsuario = usuarios.idUsuario ORDER BY `historial`.`fecha` DESC  ");
