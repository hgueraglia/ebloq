...
<head>
    ...
    <title>Alta de Emails bloqueados Zimbra</title>
...
<form action="agregar_email_bloqueado.php" method="POST">

<div class="container">
  <h2>Cargar una cuenta de </font><font class="text-primary"><strong>correo bloqueado</strong></font></h2>
  <p></p>            
  <table class="table table-striped">
    ...
    <tbody>
      <tr>
<?php        //<td><input class='' type='text' id='cuenta' name='cuenta'>@frro.utn.edu.ar</td>  ?>
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Cuenta de email Zimbra" name="cuentaemail">
            <div class="input-group-append">
            <span class="input-group-text">@frro.utn.edu.ar</span>
            </div>
        </div>
      </tr>
      <tr>
        <td>
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Motivo por el cual se bloquea" name="motivo">
            </div>
        </td>
      ...
      <td>
            <div class="form-group">
                <?php
                   echo "<input type='text' class='form-control' placeholder='Fecha en formato yyyy-mm-dd' name='fecha' value='" . $fecha_actual . "'>";
                ?>
            </div>
        </td>
...
*/        
    ...
    ?>
    <?php
        //<a href="agregar_email_bloqueado.php" class="btn btn-primary">Dar el alta</a>
    ?>
